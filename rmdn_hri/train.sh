...
CUDA_VISIBLE_DEVICES=0 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial0/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial0/log.txt &
CUDA_VISIBLE_DEVICES=1 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial1/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial1/log.txt &
CUDA_VISIBLE_DEVICES=2 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial2/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial2/log.txt &
CUDA_VISIBLE_DEVICES=3 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial3/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_noreldist/trial3/log.txt &