...
CUDA_VISIBLE_DEVICES=0 nohup python3 rmdn_hri/train_rmdvae.py --results logs/rmdn_rmg_goal/trial0/ --epochs 400 >> logs/rmdn_rmg_goal/trial0/log.txt &
CUDA_VISIBLE_DEVICES=1 nohup python3 rmdn_hri/train_rmdvae.py --results logs/rmdn_rmg_goal/trial1/ --epochs 400 >> logs/rmdn_rmg_goal/trial1/log.txt &
CUDA_VISIBLE_DEVICES=2 nohup python3 rmdn_hri/train_rmdvae.py --results logs/rmdn_rmg_goal/trial2/ --epochs 400 >> logs/rmdn_rmg_goal/trial2/log.txt &
CUDA_VISIBLE_DEVICES=3 nohup python3 rmdn_hri/train_rmdvae.py --results logs/rmdn_rmg_goal/trial3/ --epochs 400 >> logs/rmdn_rmg_goal/trial3/log.txt &