...
CUDA_VISIBLE_DEVICES=0 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial0/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial0/log.txt &
CUDA_VISIBLE_DEVICES=1 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial1/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial1/log.txt &
CUDA_VISIBLE_DEVICES=2 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial2/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial2/log.txt &
CUDA_VISIBLE_DEVICES=3 nohup python3 train_rmdvae.py --results logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial3/ --epochs 400 >> logs/rmdvae_diagcov_expdistcontrastive_alphaweights/trial3/log.txt &